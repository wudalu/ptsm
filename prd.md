...
2. **垂直领域精细化**：四个已落地垂直领域（发疯文学、AI科技资讯、每日英语学习、武侠文化）+ 一个规划中领域（现代心理困境观察）的差异化内容策略
...
| 心理观察手记 | 现代心理困境观察 | 小红书 | 5W+ | 8个月 | 🧭 产品设计 |
...
| 现代心理困境观察 | 城市年轻人、职场人、关系高敏感人群 | 场景化心理科普、情绪解释、安全边界 | 每日1次 | 现实痛点+专业边界 | 🧭 产品设计 |
...
**🧭 产品设计状态：**
- **定位**：现代人心理困境的场景化解释者，把焦虑、孤独、内耗、关系边界和数字生活压力讲清楚，但不把读者病理化
- **内容边界**：做心理教育、心理机制解释和低风险自助建议；不做诊断、治疗、药物建议、危机干预或用户心理测评
- **目标用户**：城市年轻人、职场人、大学生、关系高敏感人群、短视频/信息过载用户
- **发布策略**：每日1次，优先晚间 21:00-23:00；周末可做长文收藏型内容
- **平台优先级**：第一阶段只做小红书，验证“收藏 + 评论区经验交换”后再考虑公众号长文

**核心内容支柱：**
1. **职场心理困境**：倦怠、低控制感、反刍思维、冒名顶替感、边界感、绩效焦虑
2. **关系与孤独**：依恋焦虑、讨好、回避、社交疲惫、亲密关系不确定、原生家庭影响
3. **数字生活心理**：短视频停不下来、信息过载、比较焦虑、睡前刷手机、AI陪伴边界
4. **自我成长与情绪调节**：完美主义、情绪调节、睡眠恢复、低成本恢复、支持系统建设

**内容模板（产品设计）：**
```
🧠 你不是太敏感，可能是这个机制在起作用
【场景】[一个具体生活瞬间：如晚上还在复盘白天那句话]
【心理机制】[解释一个概念：反刍思维 / 低控制感 / 边界压力]
【误区澄清】[不是懒、不是矫情、不是一句想开点能解决]
【可以先做的小事】[1-2个低风险行动：记录触发点、减少睡前刺激、向可信任的人求助]
【边界提醒】如果痛苦持续、影响工作学习生活，或出现自伤想法，请尽快寻求专业帮助。
#心理学 #情绪管理 #自我成长
```
...
reflection:
  required_hashtag: "#心理学"
  must_include_phrase: ""
```

**建议新增 skills：**
- `psychology_style`：把心理学概念翻译成生活语言，要求“场景 -> 机制 -> 误区 -> 行动 -> 边界”
- `psychology_safety`：禁止诊断化、治疗承诺、药物建议和危机处理替代；涉及自伤/自杀/严重功能受损必须引导专业帮助
- `xhs_psychology_hashtagging`：控制标签在 5-7 个，优先 `#心理学`、`#情绪管理`、`#自我成长`、`#职场焦虑`、`#关系边界`

**首轮选题实验：**
- 职场焦虑：下班后反复复盘、开会脑子空白、被催就僵住、害怕拒绝别人
- 关系与孤独：消息不回就脑补、越长大越不想社交、讨好后的疲惫、关系里的冷处理
- 数字生活：睡前刷短视频停不下来、越看越焦虑、信息越多越难行动、AI陪伴的边界
- 情绪恢复：松弛感为什么不能硬装、情绪调节不是压下去、低成本恢复清单

**安全与合规要求：**
- 标题不得出现“你就是抑郁症/双相/ADHD/人格障碍”等诊断化表达
- 正文不得承诺“治好焦虑/治愈抑郁/替代咨询”
- 不提供用药、停药、剂量、疗法替代等医疗建议
- 对严重失眠、持续功能受损、自伤或自杀相关内容，必须提示专业帮助
- 以“现代困境 + 心理机制 + 低风险行动”为主，不把普通情绪直接病理化
...
#### 2. 领域策略编排系统
- **已落地领域编排器**：发疯文学、AI科技资讯、每日英语学习、武侠文化等 playbook 已接入
- **规划中领域**：现代心理困境观察优先通过新增 playbook + skills 接入，不新增运行时分支
...
- **领域策略引擎**：替代统一graph编排，支持已落地垂直领域独立工作流，并允许规划领域通过相同扩展点接入
...
### 📊 业务价值提升
- **多账户矩阵**：4个已落地垂直领域 + 1个规划中领域 × 多个账户的规模化运营
...
### 🔄 P3阶段进行项
- [ ] 现代心理困境观察 playbook 和 safety skill
- [ ] 微信公众号API集成
- [ ] 图片生成系统完善
- [ ] Web Dashboard开发
- [ ] 批量管理工具
