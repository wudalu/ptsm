...
- `modern_psychology_post` 的 deterministic fallback 会按场景簇生成不同候选：周日/周一预焦虑、亲密关系等待消息后的不确定感、被说想太多后的边界压力、下班后被消息拉回工位、会议尴尬复盘、脑内复盘会、普通回复复盘接龙、睡前短视频/信息过载、睡眠恢复/轻养生/办公室恢复、孤独/比较焦虑。离线草稿标题不暴露心理机制或 `不是你` 句式，机制名只在场景铺开后轻量出现一次以内，并以自然保存动作和角色/阵营/填空式评论提示收束；亲密关系等待消息场景禁止退化成职场协作、处理时间或优先级话术，睡眠恢复/轻养生场景禁止写成医疗养生号或睡眠改善承诺。
