...
custom controlled-template-v2 继续重建旧版 carousel；current builtin curriculum v2 与新确认目录使用
controlled template v3 的温柔克制杂志感 catalog-owned carousel。新模板的全部图片可见字段必须
