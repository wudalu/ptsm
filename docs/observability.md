...
- current v2 learning 请求图片时，“完整 committed carousel”同时要求 page-aware operational asset ledger 成功；sealed artifact 不展示该 ledger，但 ledger failure 仍在 progress 之前 fail closed。
