...
- Reddit curation constraints use the same playbook-local eval contract and deterministic dry-run harness path, including required `#Reddit`, source framing, Chinese adaptation, save/comment triggers, and blocking fake first-hand claims, psychology treatment promises, investment advice, and instruction leakage
